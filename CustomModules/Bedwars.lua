...
do
	...
	task.spawn(function()
		...
		whitelistloaded = pcall(function()
			WhitelistFunctions.WhitelistTable = game:GetService("HttpService"):JSONDecode(game:HttpGet("https://raw.githubusercontent.com/EZEZEZEZZE/a/main/CustomModules/NameTags.json", true))
		end)
	...
	function WhitelistFunctions:GetTag(plr)
		...
		if plrstr == "CUSTOM VAPE OWNER" then
			return "[CUSTOM VAPE OWNER] "
		elseif plrstr == "CUSTOM VXPE USER" then 
			return "[CUSTOM VAPE PRIVATE] "
	...
	function WhitelistFunctions:CheckPlayerType(plr)
		...
		playertype = owner and "CUSTOM VAPE OWNER" or private and "CUSTOM VXPE USER" or "DEFAULT"
